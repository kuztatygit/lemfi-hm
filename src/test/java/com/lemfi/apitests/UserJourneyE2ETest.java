...
import com.lemfi.model.request.PaymentRequest;
import com.lemfi.model.request.PersonalDataRequest;
import com.lemfi.model.request.RegistrationRequest;
import com.lemfi.model.response.PaymentResponse;
...
public class UserJourneyE2ETest extends BaseTest {
    ...
    void completeUserJourneyTest() {
        ...
        log.info("JSESSIONID extracted: {}", sessionId);
        ...
        log.info("STEP 3: Balance Top-Up ");
        ...
        log.info("STEP 4: Balance Verification ");
        ...
        log.info("STEP 5: Payment History Verification");
